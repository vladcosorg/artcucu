...
export default new (class {
  ...
  getGalleryURLWithTransformation(
    transformationString: string,
    fileName: string,
    format: Format,
    album = 'march',
  ) {
    return `https://res.cloudinary.com/${this.cloudName}/image/upload/${transformationString}/assets/images/gallery/${album}/${fileName}.${format}`;
  }
